...
res <- list(
    ...
    nu    = list("identity" = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 "inverse"  = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 "log"      = list(valid = c(eps, 1, 30), invalid = c(-eps, 0))),

    tau   = list("identity" = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 "inverse"  = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 "log"      = list(valid = c(eps, 1, 30), invalid = c(-eps, 0))),
    ...
    dpqr  = list("mu"    = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 ...
                 "nu"    = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)),
                 "tau"   = list(valid = c(eps, 1, 30), invalid = c(-eps, 0)))
